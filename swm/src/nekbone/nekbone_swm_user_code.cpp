...
NEKBONESWMUserCode::NEKBONESWMUserCode(
    ...
    Rx(cfg.get<uint32_t>("jobs.cfg.Rx", 1)),
    Ry(cfg.get<uint32_t>("jobs.cfg.Ry", 1)),
    Rz(cfg.get<uint32_t>("jobs.cfg.Rz", 1)),
    Ex(cfg.get<uint32_t>("jobs.cfg.Ex", 1)),
    Ey(cfg.get<uint32_t>("jobs.cfg.Ey", 1)),
    Ez(cfg.get<uint32_t>("jobs.cfg.Ez", 1)),
    Pbegin(cfg.get<uint32_t>("jobs.cfg.Pbegin", 1)),
    Pend(cfg.get<uint32_t>("jobs.cfg.Pend", 1)),
    Pstep(cfg.get<uint32_t>("jobs.cfg.Pstep", 1)),
...
Err_t  NEKBONESWMUserCode::Initial_checks()
{
    ...
    printf("\n Rtotal %d mpirank %d ", Rtotal, process_id);
